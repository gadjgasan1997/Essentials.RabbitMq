...
internal class AutoSubscribeHostedService : IHostedService
{
    ...
    private void SubscribeForEvents()
    {
        ...
        foreach (var (eventType, subscriptionKey, subscriptionOptions) in new Storage())
            SubscribeForEvent(method, eventType, subscriptionKey, subscriptionOptions);
    }
        ...
        SubscriptionOptions subscriptionOptions)
    {
        try
        {
            ...
            var result = genericMethod.Invoke(_eventsSubscriber, [subscriptionKey, subscriptionOptions]);
